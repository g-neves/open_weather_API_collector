...
def post_request():
    return openapi.Schema(
        ...
        properties={
            "user_defined_id": openapi.Schema(
                type=openapi.TYPE_STRING, description="ID defined by the user."
            ),
        },
...
def post_response():
    return openapi.Schema(
        ...
        properties={
            "user_defined_id": openapi.Schema(
                type=openapi.TYPE_INTEGER, description="ID defined by the user."
            ),
            "request_datetime": openapi.Schema(
                ...
                items=openapi.Schema(
                    ...
                    properties={
                        "city_id": openapi.Schema(
                            type=openapi.TYPE_INTEGER, description="ID of the city."
                        ),
    ...
    return openapi.Schema(
        ...
        properties={
            ...
            "Status": openapi.Schema(
                type=openapi.TYPE_STRING,
                description="Progress percentage for the specified user-defined ID.",
            ),
        },
